...
public class Program9 {
  ...
  static void foo(Object monitor, Runnable body) {
    // body jest reprezentantem obcego kodu
  ...
  public static void main(String[] args) {
    ...
    final var t1 = Threads.startNew(() -> {
      synchronized (monitor1) {
        ...
        synchronized (monitor2) {
          IO.println("t1 has monitor1 and monitor2");
        }
      }
    });
    ...
    final var t2 = Threads.startNew(() -> {
      synchronized (monitor2) {
        Threads.sleep(200);
        synchronized (monitor1) {
          IO.println("t2 has monitor2 and monitor1");
        }
      }
    });
